  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row md-flex-row justify-between mt-8">
        <h1 className="primary-heading">Fulfilment</h1>
      ...
      <div className="flex flex-col sm:flex-row md-flex-row justify-between mt-8">
        <div className="flex flex-wrap items-stretch w-72 mt-2">
          ...
          <input
            type="text"
            className="flex-shrink  leading-normal w-px flex-1 border border-l-0 h-10 border-grey-light rounded-lg rounded-l-none px-3 focus:border-blue focus:shadow"
                ...
                {customers.map((customer: CustomerModel, index) => (
                  <tr className="bg-white">
                    ...
                    <td className="p-3 text-sm whitespace-nowrap">
                      ...
                      >
                        {customer.personalDetails.vehicleModel}
                      </p>
                    </td>
                    <td className="p-3 text-sm whitespace-nowrap">
                      <StatusCard
                        key={customer.id}
                        status={customer.colStatus}
                      />
                    </td>
                    <td className="p-3 text-sm whitespace-nowrap">
                      <Link
                        to={`/fulfilment/${customer.id}`}
            ...
            {customers.map((customer: CustomerModel, index) => (
              <div className="bg-white space-y-3 p-4 rounded-lg shadow">
                <div className="flex items-center space-x-2 text-sm">
                  ...
                  <div>
                    <StatusCard key={customer.id} status={customer.colStatus} />
                  </div>
                </div>
