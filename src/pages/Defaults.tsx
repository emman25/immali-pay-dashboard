...
import { DefaultCardModel } from "./models/Cards";
import { CustomerModel, customers } from "./models/Customer";

var defaultCards: DefaultCardModel[] = [
  {
    image: "dollar_d.png",
...
function Defaults() {
  return (
    <>
      <h1 className="primary-heading">Defaulters</h1>

      <div className="flex flex-col mt-4">
        <div className="flex flex-col lg:flex-row md:flex-row sm:flex-col md:justify-between ">
          {defaultCards.map((card: any, index) => (
            <DefaultCard key={index} data={card} />
          ))}
        </div>
      </div>
                ...
                {customers.map((customer: CustomerModel, index) => (
                  <tr className="bg-white">
                    ...
                    <td className="p-3 text-sm whitespace-nowrap">
                      ...
                      >
                        {customer.loadDetails.loanAmount}
                      </p>
                    </td>
                    <td className="p-3 text-sm whitespace-nowrap">
                      <p
                      ...
                      >
                        {customer.loadDetails.dateRequested}
                      </p>
                    </td>
                    ...
                    <td className="p-3 text-sm whitespace-nowrap">
                      <StatusCard
                        key={customer.id}
                        status={customer.loadDetails.loadStatus}
                      />
                    </td>
                    <td className="p-3 text-sm whitespace-nowrap">
